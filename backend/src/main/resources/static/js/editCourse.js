...
$.ajax({
    type:'GET',
    url: "https://localhost:8443/courses/getCurrentCourse",
    dataType: 'json',
...
const sendCourse = async ({id, title, description, price, image, tags, lessons}) => {
    ...
    return await fetch('/courses/update', {
        method: 'POST',
        headers,
        body: formData
    })
